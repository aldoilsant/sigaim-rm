...
public class SEQLFromCondition {
	...
	public SEQLFromComponent createFromComponent(String referenceModelClass, String identifiedVariable, String archetypeId, Boolean useAllVersions) {
		return new SEQLFromComponent(referenceModelClass,identifiedVariable,archetypeId,useAllVersions);
	}
